...
> ### تنويه
> هئا مشروع طلابي لإعادة تصميم **الواجهة الأمامية فقط**.
...
## أهدافنا 
 ...
 3. [x] أنهاء صفحات الخدمات (تحديد الساعات ,تسجيل المواد ,إلخ)
	 1. [x] أنهاء الخدمات العادية مثل: جداول الإمتحانات تحديد الساعات
	 2. [x] إنهاء خدمات التسجيل مثل: مثل إسقاط المواد تأجيل فصل
